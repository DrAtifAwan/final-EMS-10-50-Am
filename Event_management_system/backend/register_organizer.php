...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    ...
    if ($stmt->execute()) {
        ...
        // Redirect to organizer_form.php upon successful registration
        echo "<script>
            alert('Registration successful!');
            window.location.href = 'http://localhost/eventify/backend/organizer_form.php';
        </script>";
...
<body>
<div class="container">
    <h1>Organizer Registration/Login</h1>
